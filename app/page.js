...
export default function Home() {
  return (
    <main>
      ...
      <div>
        <h1 className="text-center mt-10 text-3xl">🧉</h1>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center mt-8 space-x-3 w-full max-w-screen-xs mr-5">
        ...
        {/* <button id="tab-save" className="rounded-md bg-amber-300 px-3 py-2 text-[0.8125rem] font-semibold leading-5 text-white hover:bg-amber-600 transition ease-in-out duration-300 min-w-[200px] mb-3">
          <i className="fa-solid fa-floppy-disk"></i>
          <span className="ml-2">Exportar a PDF</span>
        </button> */}
      </div>
